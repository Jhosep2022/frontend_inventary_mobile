...
import 'package:frontend_inventary_mobile/views/Employee/placeProductsPage.dart';

class AvailableLocationsOrdersPage extends StatelessWidget {
  const AvailableLocationsOrdersPage({super.key});
      ...
      body: Column(
        ...
        children: [
          Padding(
            ...
            child: const Text(
              'Ubicaciones disponibles para cada producto',
              style: TextStyle(
                fontSize: 24,
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const PlaceProductsPage(),
                    ),
                  );
                },
