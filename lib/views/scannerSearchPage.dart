...
import 'package:frontend_inventary_mobile/views/ticketShearchPage.dart';

class ScannerSearchPage extends StatelessWidget {
  final Function(String) onScanComplete;

  const ScannerSearchPage({super.key, required this.onScanComplete});
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => TicketShearchPage(),
                      ),
                    );
                  },
